            ...
            <div class="col-lg-6 col-md-6 col-xs-12">
                ...
                <div class="col-lg-8 col-md-8 col-xs-8">
                   <?php //echo '---'. $busniessID;?>
                    ...
                    Same as <?php  echo $value['People']['first_name']; ?> <input checked="<?php echo $busniessID != '' && $busniessID == $value['People']['business_address_id'] ? 'checked': false;?>" class="other" type="radio" name=data[Address][address_grp1] value="<?php echo $value['People']['business_address_id']; ?>" /> ( <?php echo $value['address']['building_name'] . ', ' . $value['address']['complex_name'] . ', ' . $value['address']['plot_number']. ', ' .$value['address']['road'] . ', ' . $value['address']['suburb']. ', ' .$value['address']['suburb_zone'] . ', ' . $value['address']['city'] ;?>)<br />
                           <?php  } ?>
                    Other <input checked="<?php echo !in_array($aid, $ids) ? "checked" : "";?>" class="other" type="radio" name="data[Address][address_grp1]" value="other" />
                </div>  
            </div>
            <div class="col-lg-6 col-md-6 col-xs-12">&nbsp;</div>
        </div>
