...
$(function () {
    ...
    oTable = $('#getFamilyGroup').dataTable({
        ...
        "fnCreatedRow": function (nRow, aData, iDataIndex) {
            ...
            $('td:eq(3)', nRow).html('<a class="edit_row btn btn-xs btn-success" onclick="editFamilyGroup(' + aData[0] + ')" data-rowid=' + aData[0] + '><span class="glyphicon glyphicon-edit"></span>Edit</a> \n\
